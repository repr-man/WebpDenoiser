...
export const enum WeightedBlurType {
    Jpeg = 'jpeg',
    Mask = 'mask',
    Sum = 'sobel-sum',
...
export async function getWeightedBlurImage(fileName: string | undefined, imgType: WeightedBlurType, state: { projectRoot: string | undefined }) {
    if (!fileName) return "";
